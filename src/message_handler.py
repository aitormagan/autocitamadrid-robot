...
def handle_current_age(update):
    ...
    message = f"El sistema de autocita permite pedir cita a personas con {min_years} años o más️ (nacidos antes de " \
              f"{max_year_of_birth}). Si cumples con la edad, puedes ir a " \
